...
//  -------------- 网址  http://blog.csdn.net/hzmming2008/article/details/78258800 水平动态选择星期

public class WeekActivity extends AppCompatActivity {
    private static final int REQUECT_CODE_SDCARD = 2;
    protected Week weekView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<NodeInterFace> mList=new ArrayList<>();
        ...
        weekView.setData(mList, new OnWeekClickListener() {
            @Override
